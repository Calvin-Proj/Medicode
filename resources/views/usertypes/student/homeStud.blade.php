    ...
    <div class="flex flex-wrap">
        ...
        <div class="w-full md:w-1/2 xl:w-1/3 p-6">
            ...
            <div class="bg-secondary border-b-4 border-yellow-400 rounded-lg shadow-xl p-5 ">
                <div class="flex flex-row items-center">
                    <div class="flex-shrink pr-4">
                        <div class="rounded-full p-5 bg-yellow-400"><i class="fa fa-calendar fa-3x fa-inverse"></i></div>
                    </div>
                    <div class="flex-1 text-right md:text-center">
            ...
            <div class="bg-secondary border-b-4 border-yellow-400 rounded-lg shadow-xl p-5 ">
                <div class="flex flex-row items-center">
                    ...
                    <div class="flex-1 text-right md:text-center">
                        ...
                        <h3 class="font-bold text-3xl text-white">{{$booked}} <span class="text-white-500"><i class="fas fa-caret-up"></i></span></h3>
                    </div>
                </div>
            </div>
            <!--/Metric Card-->
