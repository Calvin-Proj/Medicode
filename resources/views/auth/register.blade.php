<x-guest-layout>
        ...
        <nav id="header" class="fixed w-full z-30 top-0 text-white bg-secondary">
            <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
              ...
              <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
                ...
                <button
                  id="navAction"
                  class="mx-auto lg:mx-0 hover:bg-highlight hover:underline bg-white text-black font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                >
    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <!-- Email Address -->
            <div class="mt-4">
                <x-label for="email" :value="__('University Email')" />
